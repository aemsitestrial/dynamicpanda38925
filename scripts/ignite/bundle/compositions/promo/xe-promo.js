...
// scripts/ignite/dist/compositions/promo/xe-promo.js
...
var XEPromo = class XEPromo2 extends i4 {
  constructor() {
    super(...arguments);
    this.title = "";
      ...
      <div class="promo">
        ...
        <div class="promo-grid">
          <div class="promo-content">
            ${this.title ? b2`<h2 class="promo-title">${this.title}</h2>` : A}
...
XEPromo.styles = xe_promo_default;
__decorate([
  n4({ type: String })
...
__decorate([
  n4({ type: Boolean, reflect: true, attribute: "hide-media-on-mobile" })
