...
var S = (s4, o7) => {
  if (e) s4.adoptedStyleSheets = o7.map((t4) => t4 instanceof CSSStyleSheet ? t4 : t4.styleSheet);
    ...
    void 0 !== n6 && o8.setAttribute("nonce", n6), o8.textContent = e5.cssText, s4.appendChild(o8);
  }
};
...
var y = class extends HTMLElement {
  ...
  _$AK(t4, s4) {
    ...
    if (void 0 !== e5 && this._$Em !== e5) {
      const t5 = i6.getPropertyOptions(e5), h3 = "function" == typeof t5.converter ? { fromAttribute: t5.converter } : void 0 !== t5.converter?.fromAttribute ? t5.converter : u;
      this._$Em = e5;
      const r6 = h3.fromAttribute(s4, t5.type);
      this[e5] = r6 ?? this._$Ej?.get(e5) ?? r6, this._$Em = null;
    }
  }
  requestUpdate(t4, s4, i6, e5 = false, h3) {
    if (void 0 !== t4) {
      const r6 = this.constructor;
      if (false === e5 && (h3 = this[t4]), i6 ??= r6.getPropertyOptions(t4), !((i6.hasChanged ?? f)(h3, s4) || i6.useDefault && i6.reflect && h3 === this._$Ej?.get(t4) && !this.hasAttribute(r6._$Eu(t4, i6)))) return;
      this.C(t4, s4, i6);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t4, s4, { useDefault: i6, reflect: e5, wrapped: h3 }, r6) {
    i6 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t4) && (this._$Ej.set(t4, r6 ?? s4 ?? this[t4]), true !== h3 || void 0 !== r6) || (this._$AL.has(t4) || (this.hasUpdated || i6 || (s4 = void 0), this._$AL.set(t4, s4)), true === e5 && this._$Em !== t4 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t4));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t5.size > 0) for (const [s5, i6] of t5) {
        const { wrapped: t6 } = i6, e5 = this[s5];
        true !== t6 || this._$AL.has(s5) || void 0 === e5 || this.C(s5, void 0, i6, e5);
      }
    }
    let t4 = false;
    const s4 = this._$AL;
...
var N = (t4, i6) => {
  ...
  let n6, l4 = 2 === i6 ? "<svg>" : 3 === i6 ? "<math>" : "", c5 = v;
  for (let i7 = 0; i7 < s4; i7++) {
    ...
    const x2 = c5 === p2 && t4[i7 + 1].startsWith("/>") ? " " : "";
    l4 += c5 === v ? s5 + r3 : d3 >= 0 ? (e5.push(a4), s5.slice(0, d3) + h2 + s5.slice(d3) + o3 + x2) : s5 + o3 + (-2 === d3 ? i7 : x2);
  }
  return [V(t4, l4 + (t4[s4] || "<?>") + (2 === i6 ? "</svg>" : 3 === i6 ? "</math>" : "")), e5];
};
var S2 = class _S {
  constructor({ strings: t4, _$litType$: i6 }, e5) {
    let r6;
    this.parts = [];
    let l4 = 0, a4 = 0;
    const u4 = t4.length - 1, d3 = this.parts, [f3, v2] = N(t4, i6);
    ...
    for (; null !== (r6 = P.nextNode()) && d3.length < u4; ) {
      if (1 === r6.nodeType) {
        if (r6.hasAttributes()) for (const t5 of r6.getAttributeNames()) if (t5.endsWith(h2)) {
          const i7 = v2[a4++], s4 = r6.getAttribute(t5).split(o3), e6 = /([.?@])?(.*)/.exec(i7);
          d3.push({ type: 1, index: l4, name: e6[2], strings: s4, ctor: "." === e6[1] ? I : "?" === e6[1] ? L : "@" === e6[1] ? z : H }), r6.removeAttribute(t5);
        } else t5.startsWith(o3) && (d3.push({ type: 6, index: l4 }), r6.removeAttribute(t5));
        if (y2.test(r6.tagName)) {
          const t5 = r6.textContent.split(o3), i7 = t5.length - 1;
          if (i7 > 0) {
            r6.textContent = s2 ? s2.emptyScript : "";
            for (let s4 = 0; s4 < i7; s4++) r6.append(t5[s4], c3()), P.nextNode(), d3.push({ type: 2, index: ++l4 });
            r6.append(t5[i7], c3());
          }
        }
        ...
        let t5 = -1;
        for (; -1 !== (t5 = r6.data.indexOf(o3, t5 + 1)); ) d3.push({ type: 7, index: l4 }), t5 += o3.length - 1;
      }
      l4++;
    }
  }
...
function M(t4, i6, s4 = t4, e5) {
  if (i6 === E) return i6;
  let h3 = void 0 !== e5 ? s4._$Co?.[e5] : s4._$Cl;
  const o7 = a2(i6) ? void 0 : i6._$litDirective$;
  return h3?.constructor !== o7 && (h3?._$AO?.(false), void 0 === o7 ? h3 = void 0 : (h3 = new o7(t4), h3._$AT(t4, s4, e5)), void 0 !== e5 ? (s4._$Co ??= [])[e5] = h3 : s4._$Cl = h3), void 0 !== h3 && (i6 = M(t4, h3._$AS(t4, i6.values), h3, e5)), i6;
}
var R = class {
  constructor(t4, i6) {
  ...
  u(t4) {
    const { el: { content: i6 }, parts: s4 } = this._$AD, e5 = (t4?.creationScope ?? l2).importNode(i6, true);
    P.currentNode = e5;
    let h3 = P.nextNode(), o7 = 0, n6 = 0, r6 = s4[0];
    for (; void 0 !== r6; ) {
      if (o7 === r6.index) {
        let i7;
        2 === r6.type ? i7 = new k(h3, h3.nextSibling, this, t4) : 1 === r6.type ? i7 = new r6.ctor(h3, r6.name, r6.strings, this, t4) : 6 === r6.type && (i7 = new Z(h3, this, t4)), this._$AV.push(i7), r6 = s4[++n6];
      }
...
var k = class _k {
  ...
  constructor(t4, i6, s4, e5) {
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t4, this._$AB = i6, this._$AM = s4, this.options = e5, this._$Cv = e5?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t4) {
    const { values: i6, _$litType$: s4 } = t4, e5 = "number" == typeof s4 ? this._$AC(t4) : (void 0 === s4.el && (s4.el = S2.createElement(V(s4.h, s4.h[0]), this.options)), s4);
  ...
  k(t4) {
    ...
    const i6 = this._$AH;
    let s4, e5 = 0;
    for (const h3 of t4) e5 === i6.length ? i6.push(s4 = new _k(this.O(c3()), this.O(c3()), this, this.options)) : s4 = i6[e5], s4._$AI(h3), e5++;
...
var H = class {
  ...
  constructor(t4, i6, s4, e5, h3) {
    this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t4, this.name = i6, this._$AM = e5, this.options = h3, s4.length > 2 || "" !== s4[0] || "" !== s4[1] ? (this._$AH = Array(s4.length - 1).fill(new String()), this.strings = s4) : this._$AH = A;
  }
  _$AI(t4, i6 = this, s4, e5) {
    ...
    if (void 0 === h3) t4 = M(this, t4, i6, 0), o7 = !a2(t4) || t4 !== this._$AH && t4 !== E, o7 && (this._$AH = t4);
      ...
      const e6 = t4;
      let n6, r6;
      for (t4 = h3[0], n6 = 0; n6 < h3.length - 1; n6++) r6 = M(this, e6[s4 + n6], i6, n6), r6 === E && (r6 = this._$AH[n6]), o7 ||= !a2(r6) || r6 !== this._$AH[n6], r6 === A ? t4 = A : t4 !== A && (t4 += (r6 ?? "") + h3[n6 + 1]), this._$AH[n6] = r6;
    }
    o7 && !e5 && this.j(t4);
  }
  j(t4) {
...
var D = (t4, i6, s4) => {
  ...
  if (void 0 === h3) {
    ...
    e5._$litPart$ = h3 = new k(i6.insertBefore(c3(), t5), t5, void 0, s4 ?? {});
  }
...
var r4 = (t4 = o5, e5, r6) => {
  ...
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i6, s4 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t4 = Object.create(t4)).wrapped = true), s4.set(r6.name, t4), "accessor" === n6) {
    const { name: o7 } = r6;
    return { set(r7) {
      const n7 = e5.get.call(this);
      e5.set.call(this, r7), this.requestUpdate(o7, n7, t4, true, r7);
    }, init(e6) {
  ...
  if ("setter" === n6) {
    ...
    return function(r7) {
      const n7 = this[o7];
      e5.call(this, r7), this.requestUpdate(o7, n7, t4, true, r7);
    };
  }
...
function n4(t4) {
  return (e5, o7) => "object" == typeof o7 ? r4(t4, e5, o7) : ((t5, e6, o8) => {
    ...
    return e6.constructor.createProperty(o8, t5), r6 ? Object.getOwnPropertyDescriptor(e6, o8) : void 0;
  })(t4, e5, o7);
}
...
var i5 = (t4, ...r6) => ({ _$litStatic$: r6.reduce((r7, e5, a4) => r7 + ((t5) => {
...
var n5 = (t4) => (r6, ...e5) => {
  ...
  let c5, $3 = 0, f3 = false;
  for (; $3 < a4; ) {
    for (c5 = r6[$3]; $3 < a4 && void 0 !== (i6 = e5[$3], s4 = o6(i6)); ) c5 += s4 + r6[++$3], f3 = true;
    $3 !== a4 && u4.push(i6), n6.push(c5), $3++;
  }
  if ($3 === a4 && n6.push(r6[a4]), f3) {
    const t5 = n6.join("$$lit$$");
    void 0 === (r6 = l3.get(t5)) && (n6.raw = n6, l3.set(t5, r6 = n6)), e5 = u4;
  }
  return t4(r6, ...e5);
};
var u3 = n5(b2);
...
var __decorate = function(decorators, target, key, desc) {
  ...
  else for (var i6 = decorators.length - 1; i6 >= 0; i6--) if (d3 = decorators[i6]) r6 = (c5 < 3 ? d3(r6) : c5 > 3 ? d3(target, key, r6) : d3(target, key)) || r6;
  return c5 > 3 && r6 && Object.defineProperty(target, key, r6), r6;
};
var XEBannerColumn = class XEBannerColumn2 extends i4 {
  constructor() {
    super(...arguments);
    this.align = "left";
    this.expand = false;
  ...
  render() {
    ...
    return u3`
      <div class="column align-${this.align}">
        ...
        ` : b2`<slot name="icon" @slotchange="${this._handleSlotChange}"></slot>`}
        ${this._hasHeading ? u3`
          <${tag} class="heading-wrapper ${this._hasIcon ? "has-above" : ""}">
            <slot name="heading" @slotchange="${this._handleSlotChange}"></slot>
          </${tag}>
        ` : b2`<slot name="heading" @slotchange="${this._handleSlotChange}"></slot>`}
        ${this._hasMessage ? b2`
        ...
        ` : b2`<slot name="message" @slotchange="${this._handleSlotChange}"></slot>`}
        ${this._hasAction ? b2`
        ...
        ` : b2`<slot name="action" @slotchange="${this._handleSlotChange}"></slot>`}
      </div>
    `;
  }
};
XEBannerColumn.styles = xe_banner_column_default;
__decorate([
  n4({ type: String })
...
var XEBanner = class XEBanner2 extends i4 {
  constructor() {
    super(...arguments);
    this.size = "generous";
...
XEBanner.styles = xe_banner_default;
__decorate2([
  n4({ type: String })
