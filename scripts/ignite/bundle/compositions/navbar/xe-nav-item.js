...
XEMenuItem = XEMenuItem_1 = __decorate2([
  t3("xe-menu-item")
], XEMenuItem);
...
var XENavItem = XENavItem_1 = class XENavItem2 extends i4 {
  constructor() {
    ...
    this._handleKeyDown = (e7) => {
      if (e7.key === "Escape" && this._submenuOpen) {
        e7.stopPropagation();
        this._closeMenu();
        this.shadowRoot?.querySelector("button.nav-item")?.focus();
      } else if ((e7.key === "ArrowDown" || e7.key === "Enter" || e7.key === " ") && this._hasSubmenu && !this._submenuOpen) {
        e7.preventDefault();
    ...
    return b2`
      <div class="nav-item-wrapper" @focusout=${this._handleFocusOut} @keydown=${this._handleKeyDown}>
        <button
          class=${e6(classes)}
          type="button"
          aria-haspopup=${o5(this._hasSubmenu ? "menu" : void 0)}
          aria-expanded=${o5(this._hasSubmenu ? String(this._submenuOpen) : void 0)}
          @click=${this._handleClick}>
          <slot></slot>
          ${this._hasSubmenu ? b2`
...
XENavItem = XENavItem_1 = __decorate4([
  t3("xe-nav-item")
], XENavItem);
export {
  XENavItem
