...
// scripts/ignite/dist/compositions/hero/xe-hero.js
...
var XEHero = class XEHero2 extends i4 {
  constructor() {
    super(...arguments);
    this.image = "";
    this.alt = "";
      ...
      <div class="hero">
        ...
        <div class="hero-content">
          <div class="hero-header">
            ${this.title ? b2`<h1 class="hero-title">${this.title}</h1>` : ""}
            ${this.sublabel ? b2`<p class="hero-sublabel">${this.sublabel}</p>` : ""}
          </div>
