...
// scripts/ignite/dist/compositions/spotlight/xe-spotlight.js
...
var XESpotlight = class XESpotlight2 extends i4 {
  constructor() {
    super(...arguments);
        ...
        <div class="spotlight-background">
          ${this.src ? b2`
            <picture class="spotlight-picture">
              ${this.mobileSrc ? b2`<source media="(max-width: 768px)" srcset="${this.mobileSrc}">` : A}
              <img class="spotlight-image" src="${this.src}" alt="">
            </picture>
          ` : b2`<slot name="background"></slot>`}
        </div>
...
XESpotlight.styles = xe_spotlight_default;
__decorate([
