...
var i = (t5, ...e8) => {
  const o6 = 1 === t5.length ? t5[0] : e8.reduce((e9, s4, o7) => e9 + ((t6) => {
...
function M(t5, i6, s4 = t5, e8) {
  ...
  return h3?.constructor !== o6 && (h3?._$AO?.(false), void 0 === o6 ? h3 = void 0 : (h3 = new o6(t5), h3._$AT(t5, s4, e8)), void 0 !== e8 ? (s4._$Co ??= [])[e8] = h3 : s4._$Cl = h3), void 0 !== h3 && (i6 = M(t5, h3._$AS(t5, i6.values), h3, e8)), i6;
}
var R = class {
  constructor(t5, i6) {
...
var H = class {
  ...
  _$AI(t5, i6 = this, s4, e8) {
    ...
    if (void 0 === h3) t5 = M(this, t5, i6, 0), o6 = !a2(t5) || t5 !== this._$AH && t5 !== E, o6 && (this._$AH = t5);
      ...
      const e9 = t5;
      let n5, r6;
      for (t5 = h3[0], n5 = 0; n5 < h3.length - 1; n5++) r6 = M(this, e9[s4 + n5], i6, n5), r6 === E && (r6 = this._$AH[n5]), o6 ||= !a2(r6) || r6 !== this._$AH[n5], r6 === A ? t5 = A : t5 !== A && (t5 += (r6 ?? "") + h3[n5 + 1]), this._$AH[n5] = r6;
    }
    o6 && !e8 && this.j(t5);
  }
  j(t5) {
...
// node_modules/@ignite/web/dist/primitives/layout/card-grid/xe-card-grid.js
...
var XECardGrid_1;
var XECardGrid = XECardGrid_1 = class XECardGrid2 extends i4 {
  constructor() {
    super(...arguments);
    this.gap = "md";
  }
  render() {
    const isExplicit = this.columns !== void 0;
    const styles = [
...
XECardGrid.styles = xe_card_grid_default;
XECardGrid._gapVars = {
...
XEIconButton = __decorate3([
  t3("xe-icon-button")
], XEIconButton);

// node_modules/@ignite/web/dist/primitives/layout/carousel/xe-carousel.js
...
var XECarousel = class XECarousel2 extends i4 {
  constructor() {
    super(...arguments);
  ...
  _setupFocusManagement() {
    this.addEventListener("focusin", (e8) => {
      if (!this._track)
        return;
  ...
  render() {
    return b2`
      ...
      ${!this.hideControls || !this.hideIndicators ? b2`
        <div class="paginator">
          ${!this.hideControls ? b2`
            <xe-icon-button
              aria-label="Previous"
          ...
          ${!this.hideIndicators ? b2`
            <div class="dots" role="tablist" aria-label="Carousel position">
              ${Array.from({ length: this._itemCount }, (_2, i6) => b2`
                <button
                  class="dot ${i6 === this._currentIndex ? "active" : ""}"
                  role="tab"
                  aria-selected=${i6 === this._currentIndex ? "true" : "false"}
                  aria-label="Go to item ${i6 + 1}"
                  @click=${() => this._handleDotClick(i6)}>
                </button>
              `)}
            </div>
          ` : A}
...
XECarousel.styles = xe_carousel_default;
__decorate4([
  n4({ type: Boolean, attribute: "hide-controls" })
], XECarousel.prototype, "hideControls", void 0);
__decorate4([
  n4({ type: Boolean, attribute: "hide-indicators" })
...
var XEFeatureCards = class XEFeatureCards2 extends i4 {
  constructor() {
    super(...arguments);
    this.heading = "";
    this.subheading = "";
      ...
      <div class="feature-cards">
        ${this.heading ? b2`
          <div class="section-header">
            ...
            ${this.subheading ? b2`<p class="section-subheading">${this.subheading}</p>` : ""}
          </div>
        ` : ""}
        ${useCarousel ? b2`<xe-carousel class="cards-carousel" desktop-layout="grid" style="--xe-carousel-columns: ${this.columns ?? 3}"><slot></slot></xe-carousel>` : b2`<xe-card-grid .columns=${this.columns}><slot></slot></xe-card-grid>`}
      </div>
    `;
  }
};
XEFeatureCards.styles = xe_feature_cards_default;
__decorate5([
  n4({ type: String })
...
__decorate5([
  n4({ type: String, reflect: true, attribute: "header-align" })
...
__decorate5([
  n4({ type: String, reflect: true, attribute: "mobile-layout" })
], XEFeatureCards.prototype, "mobileLayout", void 0);
XEFeatureCards = __decorate5([
  t3("xe-feature-cards")
], XEFeatureCards);
export {
  XEFeatureCards
