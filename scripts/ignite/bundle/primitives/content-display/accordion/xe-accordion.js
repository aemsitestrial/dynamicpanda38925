...
var y = class extends HTMLElement {
  ...
  requestUpdate(t4, s4, i6, e5 = false, h3) {
    if (void 0 !== t4) {
      ...
      if (false === e5 && (h3 = this[t4]), i6 ??= r5.getPropertyOptions(t4), !((i6.hasChanged ?? f)(h3, s4) || i6.useDefault && i6.reflect && h3 === this._$Ej?.get(t4) && !this.hasAttribute(r5._$Eu(t4, i6)))) return;
      this.C(t4, s4, i6);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t4, s4, { useDefault: i6, reflect: e5, wrapped: h3 }, r5) {
    i6 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t4) && (this._$Ej.set(t4, r5 ?? s4 ?? this[t4]), true !== h3 || void 0 !== r5) || (this._$AL.has(t4) || (this.hasUpdated || i6 || (s4 = void 0), this._$AL.set(t4, s4)), true === e5 && this._$Em !== t4 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t4));
  }
  async _$EP() {
    ...
    for (; null !== (r5 = P.nextNode()) && d3.length < u4; ) {
      if (1 === r5.nodeType) {
        if (r5.hasAttributes()) for (const t5 of r5.getAttributeNames()) if (t5.endsWith(h2)) {
          const i7 = v2[a4++], s4 = r5.getAttribute(t5).split(o3), e6 = /([.?@])?(.*)/.exec(i7);
          d3.push({ type: 1, index: l4, name: e6[2], strings: s4, ctor: "." === e6[1] ? I : "?" === e6[1] ? L : "@" === e6[1] ? z : H }), r5.removeAttribute(t5);
        } else t5.startsWith(o3) && (d3.push({ type: 6, index: l4 }), r5.removeAttribute(t5));
        if (y2.test(r5.tagName)) {
          const t5 = r5.textContent.split(o3), i7 = t5.length - 1;
          if (i7 > 0) {
            r5.textContent = s2 ? s2.emptyScript : "";
            for (let s4 = 0; s4 < i7; s4++) r5.append(t5[s4], c3()), P.nextNode(), d3.push({ type: 2, index: ++l4 });
            r5.append(t5[i7], c3());
          }
        }
        ...
        let t5 = -1;
        for (; -1 !== (t5 = r5.data.indexOf(o3, t5 + 1)); ) d3.push({ type: 7, index: l4 }), t5 += o3.length - 1;
      }
      l4++;
    }
  }
...
var R = class {
  ...
  u(t4) {
    ...
    for (; void 0 !== r5; ) {
      if (o7 === r5.index) {
        let i7;
        2 === r5.type ? i7 = new k(h3, h3.nextSibling, this, t4) : 1 === r5.type ? i7 = new r5.ctor(h3, r5.name, r5.strings, this, t4) : 6 === r5.type && (i7 = new Z(h3, this, t4)), this._$AV.push(i7), r5 = s4[++n6];
      }
...
var H = class {
  ...
  _$AI(t4, i6 = this, s4, e5) {
    ...
    if (void 0 === h3) t4 = M(this, t4, i6, 0), o7 = !a2(t4) || t4 !== this._$AH && t4 !== E, o7 && (this._$AH = t4);
      ...
      const e6 = t4;
      let n6, r5;
      for (t4 = h3[0], n6 = 0; n6 < h3.length - 1; n6++) r5 = M(this, e6[s4 + n6], i6, n6), r5 === E && (r5 = this._$AH[n6]), o7 ||= !a2(r5) || r5 !== this._$AH[n6], r5 === A ? t4 = A : t4 !== A && (t4 += (r5 ?? "") + h3[n6 + 1]), this._$AH[n6] = r5;
    }
    o7 && !e5 && this.j(t4);
  }
  j(t4) {
...
var i5 = (t4, ...r5) => ({ _$litStatic$: r5.reduce((r6, e5, a4) => r6 + ((t5) => {
...
var n4 = (t4) => (r5, ...e5) => {
  ...
  let c5, $3 = 0, f3 = false;
  for (; $3 < a4; ) {
    for (c5 = r5[$3]; $3 < a4 && void 0 !== (i6 = e5[$3], s4 = o5(i6)); ) c5 += s4 + r5[++$3], f3 = true;
    $3 !== a4 && u4.push(i6), n6.push(c5), $3++;
  }
  if ($3 === a4 && n6.push(r5[a4]), f3) {
    const t5 = n6.join("$$lit$$");
    void 0 === (r5 = l3.get(t5)) && (n6.raw = n6, l3.set(t5, r5 = n6)), e5 = u4;
  }
  return t4(r5, ...e5);
};
var u3 = n4(b2);
...
var r4 = (t4 = o6, e5, r5) => {
  const { kind: n6, metadata: i6 } = r5;
  let s4 = globalThis.litPropertyMetadata.get(i6);
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i6, s4 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t4 = Object.create(t4)).wrapped = true), s4.set(r5.name, t4), "accessor" === n6) {
    const { name: o7 } = r5;
    return { set(r6) {
      const n7 = e5.get.call(this);
      e5.set.call(this, r6), this.requestUpdate(o7, n7, t4, true, r6);
    }, init(e6) {
  ...
  if ("setter" === n6) {
    ...
    return function(r6) {
      const n7 = this[o7];
      e5.call(this, r6), this.requestUpdate(o7, n7, t4, true, r6);
    };
  }
...
var __decorate = function(decorators, target, key, desc) {
  ...
  else for (var i6 = decorators.length - 1; i6 >= 0; i6--) if (d3 = decorators[i6]) r5 = (c5 < 3 ? d3(r5) : c5 > 3 ? d3(target, key, r5) : d3(target, key)) || r5;
