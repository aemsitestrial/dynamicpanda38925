...
// scripts/ignite/dist/primitives/media/youtube-embed/xe-youtube-embed.js
...
var XEYoutubeEmbed = class XEYoutubeEmbed2 extends i4 {
  constructor() {
    super(...arguments);
    this.videoid = "";
    this.videoTitle = "";
  ...
  render() {
    ...
    return b2`
      <div class="xeyt-container" @click=${() => {
...
XEYoutubeEmbed.styles = xe_youtube_embed_default;
__decorate([
  n4({ type: String })
], XEYoutubeEmbed.prototype, "videoid", void 0);
__decorate([
  n4({ type: String, attribute: "title" })
