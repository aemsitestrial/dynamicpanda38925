...
var XEMenuItem = XEMenuItem_1 = class XEMenuItem2 extends i4 {
  ...
  _handleKeyDown(e5) {
    if (e5.key === "Enter" || e5.key === " ") {
    ...
    } else if (e5.key === "Escape" && this._submenuOpen) {
      e5.stopPropagation();
      this._submenuOpen = false;
      if (XEMenuItem_1._openMenuItem === this)
        XEMenuItem_1._openMenuItem = null;
      ...
      e5.preventDefault();
      e5.stopPropagation();
      this._moveSiblingFocus(e5.key === "ArrowDown" ? 1 : -1, e5.composedPath());
    } else if (e5.key === "ArrowRight" && this._hasSubmenu) {
      e5.preventDefault();
      e5.stopPropagation();
