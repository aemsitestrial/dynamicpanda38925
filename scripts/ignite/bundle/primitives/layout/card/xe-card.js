...
var XECard = class XECard2 extends i4 {
  constructor() {
    super(...arguments);
  ...
  firstUpdated() {
    ...
    this._hasBody = Array.from(this.childNodes).some((n5) => n5.nodeType === Node.ELEMENT_NODE && !n5.hasAttribute("slot") || n5.nodeType === Node.TEXT_NODE && !!n5.textContent?.trim());
    if (this._hasActions)
      this._applyButtonThemes();
  }
  updated(changedProperties) {
    super.updated(changedProperties);
    if (changedProperties.has("interactive") || changedProperties.has("hideActionsMobile") || changedProperties.has("treatmentMobile") || changedProperties.has("alignMobile") || changedProperties.has("headerJustifyMobile")) {
      this._cleanupMediaQuery();
      this._setupResponsiveTracking();
      this.requestUpdate();
    }
  ...
  _setupResponsiveTracking() {
    ...
    const handler = (e7) => {
      this._isMobileViewport = e7.matches;
      this.requestUpdate();
    };
  ...
  _applyButtonThemes() {
    ...
    const buttons = actionsEl.tagName.toLowerCase() === "xe-button" ? [actionsEl] : Array.from(actionsEl.querySelectorAll("xe-button"));
  ...
  render() {
    const aspectRatioClass = this.aspectRatio !== "auto" ? `aspect-${this.aspectRatio.replace(":", "-")}` : "";
    const classes = {
      card: true,
      [this.variant]: true,
    ...
    const cardContent = b2`
      <slot name="media"></slot>
      ${this.overlayColor ? b2`
        <div
          class="overlay"
      ...
      ` : A}
      ${this._hasDecorative ? b2`<slot name="decorative"></slot>` : A}
    `;
    ...
    return b2`
      <div class=${e6(classes)} @click=${this._handleClick}>
        ${cardContent}
      </div>
    `;
  }
};
XECard.styles = xe_card_default;
__decorate([
  n4({ type: String })
...
__decorate([
  n4({ type: String, attribute: "aspect-ratio" })
], XECard.prototype, "aspectRatio", void 0);
__decorate([
  n4({ type: String, reflect: true, attribute: "decorative-position" })
], XECard.prototype, "decorativePosition", void 0);
__decorate([
  n4({ type: String, attribute: "actions-position" })
], XECard.prototype, "actionsPosition", void 0);
__decorate([
  n4({ type: String, attribute: "actions-placement" })
], XECard.prototype, "actionsPlacement", void 0);
__decorate([
  n4({ type: String, attribute: "overlay-color" })
], XECard.prototype, "overlayColor", void 0);
__decorate([
  n4({ type: Number, attribute: "overlay-opacity" })
], XECard.prototype, "overlayOpacity", void 0);
__decorate([
  n4({ type: String })
], XECard.prototype, "align", void 0);
__decorate([
  n4({ type: String, attribute: "align-mobile" })
], XECard.prototype, "alignMobile", void 0);
__decorate([
  n4({ type: String, attribute: "header-justify" })
], XECard.prototype, "headerJustify", void 0);
__decorate([
  n4({ type: String, attribute: "header-justify-mobile" })
], XECard.prototype, "headerJustifyMobile", void 0);
__decorate([
  n4({ type: Boolean, attribute: "hide-actions-mobile" })
], XECard.prototype, "hideActionsMobile", void 0);
__decorate([
  n4({ type: String, attribute: "treatment-mobile" })
